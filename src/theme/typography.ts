...
export const typography = {
  ...
  "label-18_semibold": { weight: "SemiBold", size: 18, ratio: 1.35 },
  "label-18_medium": { weight: "Medium", size: 18, ratio: 1.35 },
  "label-16_bold": { weight: "Bold", size: 16, ratio: 1.2, tracking: -2 },
  "label-16_semibold": { weight: "SemiBold", size: 16, ratio: 1.6, tracking: -2 },
  "label-16_medium": { weight: "Medium", size: 16, ratio: 1.6, tracking: -2 },
  "label-16_regular": { weight: "Regular", size: 16, ratio: 1.6, tracking: -2 },
  "label-14": { weight: "SemiBold", size: 14, ratio: 1.5, tracking: -1 },
  "label-12_regular": { weight: "Regular", size: 12, ratio: 1.2, tracking: -1 },

  price_detail: { weight: "Bold", size: 20, ratio: 1.4, tracking: -2 },
  discount: { weight: "Medium", size: 20, ratio: 1.4, tracking: -4 },
  price_s: { weight: "Bold", size: 12, ratio: 1.2 },
  brand_s: { weight: "Bold", size: 10, ratio: 1.2 },
  name_s: { weight: "Medium", size: 10, ratio: 1.2 },
